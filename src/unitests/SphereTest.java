...
public class SphereTest {
    ...
    public void testFindIntersections() {
        ...
        result = sphere.findIntersections(new Ray(new Point3D(0.5, 0, 0),
                new Vector(1.08, -0.02, 0.82)));
        assertEquals("Wrong number of points", 1, result.size());
      // assertEquals("Wrong point", new Point3D(1.58,-0.02,0.82), result.get(0));
        ...
        result = sphere.findIntersections(new Ray(new Point3D(1.5, 0.87, 0),
                new Vector(0, -1.73, 0)));
        
        assertEquals("Wrong number of points", 1, result.size());
        assertEquals("Wrong point", new Point3D(1.5, -0.87, 0), result.get(1));
