...
public class LightsTests {
	...
	public void sphereSpotSharp() {
		...
		scene1.lights.add(new SpotLight(new Color(500, 300, 0), new Point3D(-50, -50, 50),  1,
				0.000005, 0.00000025, new Vector(1, 1, -2)/*5*/));
	...
	public void trianglesSpotSharp() {
		...
		scene2.lights.add(new SpotLight(new Color(800, 400, 400), new Point3D(10, -10, -130),  1,
				0.00005, 0.0000025, new Vector(-2, -2, -1) /*5*/));
	...
	public void sphereAllLights() {
		scene1.geometries.add(sphere);
		scene1.lights.add(new SpotLight(new Color(0, 500, 0), new Point3D(50, -50, 20),  1,
				0.000005, 0.00000025, new Vector(-1, 1, -1)/*5*/));
		scene1.lights.add(new DirectionalLight(new Vector(2, -7, -3), new Color(500, 500, 500)));
		scene1.lights.add(new PointLight(new Color(800, 300, 0), new Point3D(-50, -50, 20), 1, 0.00001, 0.0003));
	...
	public void trianglesAllLights() {
		scene2.geometries.add(triangle1.setMaterial(new Material().setKd(0.5).setKs(0.5).setEnShininess(300)),
				triangle2.setMaterial(new Material().setKd(0.5).setKs(0.5).setEnShininess(300)));
		scene2.lights.add(new SpotLight(new Color(0, 500, 0), new Point3D(50, -50, 20),  1,
				0.000005, 0.00000025, new Vector(-1, 1, -1)/*5*/));
		scene2.lights.add(new PointLight(new Color(0, 150, 300), new Point3D(30, -70, -130), 1, 0.0005, 0.0005));
		scene2.lights.add(new DirectionalLight(new Vector(0, 0, -1), new Color(300, 150, 150)));
